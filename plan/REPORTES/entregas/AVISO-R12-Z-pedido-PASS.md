...
| dato | valor |
| ---- | ----- |
| Tip canónico | `e18e7e2` = `e18e7e275b00f0455bb8c975092cf22b8b69346c` |
...
```text
e18e7e2 plan(gobierno): tip SHA HEAD R12-Z reintento PASS
...
tip canónico: e18e7e2 (= origin/main · sin divergencia · incluye corrección + este aviso)
