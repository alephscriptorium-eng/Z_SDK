/**
 * Smoke test for @zeus/cache-browser — ephemeral port, GET / and /health.
 */
...
const TEST_PORT = 14015;

test('cache-browser smoke', async (t) => {
  const handle = await createViewServer({ port: TEST_PORT });
