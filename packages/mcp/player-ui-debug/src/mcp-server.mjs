...
function getPromptRegistry() {
  return [
    ...
    },
    {
      ...
      title: 'player-ui-debug medicion exploration',
    ...
    },
    {
      ...
      title: 'player-ui-debug snapshot inspection',
      description:
    ...
    },
    {
      ...
      title: 'player-ui-debug transport control',
      description:
    ...
    {
      name: 'tail-events',
      title: 'player-ui-debug event tail',
    ...
    {
      name: 'fetch-anchors',
      title: 'player-ui-debug Wave A anchors',
    ...
    },
    {
      ...
      title: 'player-ui-debug recovery recipe',
      description:
    ...
    {
      name: 'self-check',
      title: 'player-ui-debug prompt self-check',
      description:
        'Validate all monitor prompts: render, URI/tool refs, and approval gate on transport-control.',
      argsSchema: {},
      render: () => {
        const steps = [
          'Run a self-check of all player-ui-debug MCP prompts (read-only; touches data, zero mutation).',
          '',
          'Steps:',
