...
// Estas importaciones serían necesarias en una aplicación real
// import { ThreeJSLayoutConfig, ThreeJSSceneConfig } from 'threejs-gamification-ui';

// Para este ejemplo, definimos las interfaces localmente
interface ThreeJSLayoutConfig {
  gameTitle: string;
...
export class EjemploModularComponent {
  ...
  eventosControles = {
    ...
    speedChange: { emit: (speed: string) => console.log('Speed:', speed) }, // Changed from number to string
