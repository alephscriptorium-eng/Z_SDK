/**
 * Declarations for `@zeus/linea-kit/schemas/manifest-tronco.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `ManifestTronco`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import manifestTroncoSchema from '@zeus/linea-kit/schemas/manifest-tronco.json'
