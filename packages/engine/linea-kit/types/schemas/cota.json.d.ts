/**
 * Declarations for `@zeus/linea-kit/schemas/cota.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `Cota`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import cotaSchema from '@zeus/linea-kit/schemas/cota.json'
