/**
 * Declarations for `@zeus/linea-kit/schemas/triage-manifest.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `TriageManifest`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import triageManifestSchema from '@zeus/linea-kit/schemas/triage-manifest.json'
