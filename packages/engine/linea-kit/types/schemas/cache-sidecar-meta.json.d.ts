/**
 * Declarations for `@zeus/linea-kit/schemas/cache-sidecar-meta.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `CacheSidecarMeta`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import cacheSidecarMetaSchema from '@zeus/linea-kit/schemas/cache-sidecar-meta.json'
