/**
 * Declarations for `@zeus/linea-kit/schemas/force.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `Force`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import forceSchema from '@zeus/linea-kit/schemas/force.json'
