/**
 * Declarations for `@zeus/linea-kit/schemas/manifest-satelite.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `ManifestSatelite`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import manifestSateliteSchema from '@zeus/linea-kit/schemas/manifest-satelite.json'
