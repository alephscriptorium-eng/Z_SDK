/**
 * Declarations for `@zeus/linea-kit/schemas/ontology-seeds.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `OntologySeeds`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import ontologySeedsSchema from '@zeus/linea-kit/schemas/ontology-seeds.json'
