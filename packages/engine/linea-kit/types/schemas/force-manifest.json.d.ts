/**
 * Declarations for `@zeus/linea-kit/schemas/force-manifest.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `ForceManifest`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import forceManifestSchema from '@zeus/linea-kit/schemas/force-manifest.json'
