/**
 * Declarations for `@zeus/linea-kit/schemas/lineas-registry.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `LineasRegistry`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import lineasRegistrySchema from '@zeus/linea-kit/schemas/lineas-registry.json'
