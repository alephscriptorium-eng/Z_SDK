/**
 * Declarations for `@zeus/linea-kit/schemas/ssb-manifest.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `SsbManifest`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import ssbManifestSchema from '@zeus/linea-kit/schemas/ssb-manifest.json'
