/**
 * Declarations for `@zeus/linea-kit/schemas/nodo-sections.json`.
 *
 * The default export is the JSON Schema DOCUMENT itself (title
 * `NodoSections`), not the data it validates. Only the five members every
 ...
 *
 * ```ts
 *   import nodoSectionsSchema from '@zeus/linea-kit/schemas/nodo-sections.json'
