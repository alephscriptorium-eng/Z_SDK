...
```bash
npm exec -w @zeus/playbook-kit -- zeus-playbook-run --casos Z_SDK-games-library/packages/delta/spec/CASOS.md --check
npm exec -w @zeus/playbook-kit -- zeus-playbook-run \
  --casos Z_SDK-games-library/packages/delta/spec/CASOS.md \
